...
\node at (8.7,0){\Huge\textcolor{vermelho}{{10{\%}} } };
...
\node at (8.7,0){\Huge\textcolor{laranja}{{2.5{\%}} } };
...
\node at (8.7,0){\Huge\textcolor{verde}{{20{\%}} } };
...
\node at (8.7,0){\Huge\textcolor{azul}{{67.5{\%}} } };
...
\def\perfilprincipal{4}
\def\perfilsecundario{3}


\ifnum\perfilprincipal=1
{Michelle }{, }{\input{txt/d1.txt}}
\fi

\ifnum\perfilprincipal=2
{Michelle }{, }{\input{txt/i1.txt}}
\fi

\ifnum\perfilprincipal=3
{Michelle }{, }{\input{txt/s1.txt}}
\fi

\ifnum\perfilprincipal=4
{Michelle }{, }{\input{txt/c1.txt}}
\fi
