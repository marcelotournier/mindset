...
\node at (8.7,0){\Huge\textcolor{vermelho}{{15.6{\%}} } };
...
\node at (8.7,0){\Huge\textcolor{laranja}{{81.2{\%}} } };
...
\node at (8.7,0){\Huge\textcolor{verde}{{9.4{\%}} } };
...
\node at (8.7,0){\Huge\textcolor{azul}{{18.8{\%}} } };
...
\def\perfilprincipal{2}
\def\perfilsecundario{4}


\ifnum\perfilprincipal=1
{mac teste}{, }{\input{txt/d1.txt}}
\fi

\ifnum\perfilprincipal=2
{mac teste}{, }{\input{txt/i1.txt}}
\fi

\ifnum\perfilprincipal=3
{mac teste}{, }{\input{txt/s1.txt}}
\fi

\ifnum\perfilprincipal=4
{mac teste}{, }{\input{txt/c1.txt}}
\fi
